...
All extensions are developed by me and licensed under MIT.

| **Extension Name** | **Task** | **Link** |
|----------|----------|----------|
...
| Wikipedia Search | Live Wikipedia search with inline article previews. | [abh80/raycast-wikipedia](https://github.com/abh80/raycast-wikipedia) |
